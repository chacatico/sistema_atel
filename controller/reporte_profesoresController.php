...
$total_registros = $p->get_contar_profesores();

$profesores = $p->get_paginacion_profesores_report(0, $total_registros);
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Ln();
        $this->SetFont('Arial','B',15);
        $this->Cell(0,10,utf8_decode('Listado de Profesores'),0,0,'C');
        $this->Ln();
    }
